...
import ed.alurahotel.controller.HuespedController;
import ed.alurahotel.controller.ReservaController;
...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Busqueda.class.getResource("/ed/alurahotel/imagenes/lupa2.png")));
		...
		panel.addTab("Reservas", new ImageIcon(Busqueda.class.getResource("/ed/alurahotel/imagenes/reservado.png")), scroll_table, null);
		...
		panel.addTab("Huéspedes", new ImageIcon(Busqueda.class.getResource("/ed/alurahotel/imagenes/pessoas.png")), scroll_tableHuespedes, null);
		scroll_tableHuespedes.setVisible(true);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon(Busqueda.class.getResource("/ed/alurahotel/imagenes/Ha-100px.png")));
			...
			public void mouseClicked(MouseEvent e) {
				...
				case 0:
					...
					if (!txtBuscar.getText().isEmpty()) {					
						...
						JOptionPane.showMessageDialog(null, "Reserva - Ingresar el ID a buscar");
	...
	// Seleccion de item tabla
	  ...
	  private void modificarReserva() {
		  if (tieneFilaElegida(0)) {
	            JOptionPane.showMessageDialog(this, "Reserva - Por favor, elije un item");		
	            return;
	        } 
	...
	// Modificar huesped
		  private void modificarHuesped() {
			  if (tieneFilaElegida(1)) {
		            JOptionPane.showMessageDialog(this, "Huesped - Por favor, elije un item");		
		            return;
		        } 
	            ...
	            .ifPresentOrElse(fila -> {
	                ...
	                JOptionPane.showMessageDialog(this, String.format("%d Huesped - modificado con éxito!", filasModificadas));
		  ...
		  private void eliminarReserva() {
		        ...
		        Optional.ofNullable(modelo.getValueAt(tbReservas.getSelectedRow(), tbReservas.getSelectedColumn()))
		                .ifPresentOrElse(fila -> {
		                    ...
		                    JOptionPane.showMessageDialog(this, cantidadEliminada + " Reserva - eliminado con éxito! Huesped " + cantidadEliminadaHuesped);
		                }, () -> JOptionPane.showMessageDialog(this, "Reserva - Por favor, elije un item"));
		    }
...
// Eliminar huésped
		  ...
		  private void eliminarHuesped() {
		        if (tieneFilaElegida(1)) {
		            JOptionPane.showMessageDialog(this, "Huespede - Por favor, elije un item");
		            return;
		        }
		        ...
		        Optional.ofNullable(modeloHuesped.getValueAt(tbHuespedes.getSelectedRow(), tbHuespedes.getSelectedColumn()))
		                .ifPresentOrElse(fila -> {
		                    ...
		                    JOptionPane.showMessageDialog(this, cantidadEliminada + " Huesped - eliminado con éxito! Reserva " + cantidadEliminadaReserva);
